/*
Nama      : Mochammad Ghifari Eka Narayana, Matthew Felix Ristant
NPM       : 140810190021, 140810190047
Kelas     : A
...
int main(){
	...
	int key[2][2];
	string plain,cipher;
    // Masukkan Key untuk enkripsi dan dekripsi
    cout << "Masukkan matriks Key (2x2) :\n";
    for(int i = 0; i < 2; i++)
    for(int j = 0; j < 2; j++) {
        cin >> key[i][j];
	...
	while(menuActive){ //membuat program bersifat berulang
